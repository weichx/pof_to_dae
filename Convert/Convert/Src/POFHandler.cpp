...
bool POF::T_Get_Bank(int mode, int bank, int &sobj_parent, int &sobj_par_phys, vector3d &normal)
{
	if ((unsigned)bank > T_Count_Banks(mode))
		return false;
	//if (mode == 1) {
	//	sobj_parent = turretmissiles.banks[bank].sobj_parent;
	//	sobj_par_phys = turretmissiles.banks[bank].sobj_par_phys;
	//	normal = turretmissiles.banks[bank].turret_normal;
	//}else {
	//	sobj_parent = turretguns.banks[bank].sobj_parent;
	//	sobj_par_phys = turretguns.banks[bank].sobj_par_phys;
	//	normal = turretguns.banks[bank].turret_normal;
	//}
	//Matt --- un aliased below for readablilty
